        ...
        <CmnHeading
          ...
          details={
            <>
              ...
              <p className='second-para'>Ut fermentum elementum amet elementum arcu suspendisse. Vitae lectus penatibus est sit iaculis quis. Auctor eu vitae imperdiet dignissim hendrerit. A elementum turpis sem quis.</p>
            </>
          } align="left"
        />
        <div className="bt">
